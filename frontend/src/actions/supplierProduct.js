  ...
  async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.post(
        `${process.env.REACT_APP_API_URL}/api/supplier`,
        {
          name,
          email,
          address,
...
export const getroductsDetails = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API_URL}/api/supplier/product/${id}`,
      config
    );
...
export const createProductReview =
  (productId, review) => async (dispatch, getState) => {
    try {
      ...
      await axios.post(
        `${process.env.REACT_APP_API_URL}/api/supplier/product/${productId}/reviews`,
        review,
        config
      );
...
export const updateReviewed = (product) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `${process.env.REACT_APP_API_URL}/api/supplier/product/${product._id}/reviews`,
      product,
      config
    );
...
export const updateSupplierProduct =
  (product) => async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.put(
        `${process.env.REACT_APP_API_URL}/api/supplier/product/${product._id}/edit`,
        product,
        config
      );
...
export const listSupplierProductsForAll = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API_URL}/api/supplier/all`
    );
